...
$.extend($.easing, {
    ...
    }), $(".Home-Page-Only #newsletter-popup").length > 0 && "true" !== Riode.getCookie("hideNewsletterPopup") && setTimeout(function () {
        Riode.popup({
            items: {
    ...
    return {
        init: function () {
            ...
            t.className = "minipopup-area2", Riode.byClass("page-wrapper")[0].appendChild(t), (e = $(t)).on("click", ".btn-close", function (e) {
